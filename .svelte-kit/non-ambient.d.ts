...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/advanced-scene-manager" | "/favicon.ico" | "/showcase" | "/showcase/advanced-scene-manager" | "/support";
		RouteParams(): {
