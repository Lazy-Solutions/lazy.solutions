...
public class SceneLoader : MonoBehaviour
{
    ...
    public void OpenMainMenu()
    {
        ...
        workflows.</a></p></section> <section class="asm-section"><h2>Ready to simplify your Unity scene management?</h2> <p class="asm-cta-intro"><a${attr("href", trialUrl)} target="_blank" rel="noopener noreferrer">Try the free trial</a> first, then grab the full version on the Unity Asset Store.</p> <div class="asm-cta-buttons asm-cta-buttons-final"><a${attr("href", assetStoreUrl)} class="buy-btn" target="_blank" rel="noopener noreferrer sponsored">Buy on Unity Asset Store</a></div> <p class="support asm-cta-support">Questions? Join our <a href="https://discord.com/invite/ayE4EHB6bQ" target="_blank" rel="noopener noreferrer">Discord community</a> for support and updates.</p></section></main>`);
}
//#endregion
