...
return {
	...
	_: {
		...
		prerendered_routes: new Set(["/","/advanced-scene-manager","/blog","/blog/__data.json","/showcase/advanced-scene-manager","/sitemap.xml","/support","/blog/page/1","/blog/why-we-use-partial-classes-when-building-unity-tools","/blog/how-to-access-internal-classes-and-methods-in-unity"]),
		matchers: async () => {
